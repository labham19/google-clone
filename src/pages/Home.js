...
const Home = () =>{
  ...
  return (
    <div className='h-full w-full'>  
      ...
      <div className='flex flex-col justify-center items-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 space-y-6'>
          
          <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Google_2015_logo.svg/1200px-Google_2015_logo.svg.png" className='w-2/5'/>
          
          <div className='flex justify-between items-center w-2/3 px-4 py-2 border-2 rounded-3xl hover:bg-slate-100'>
